...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Constraint.annotation'
        db.add_column('api_constraint', 'annotation', self.gf('django.db.models.fields.related.ForeignKey')(default=16, related_name='constraints', to=orm['api.Annotation']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Constraint.annotation'
        db.delete_column('api_constraint', 'annotation_id')
    ...
    models = {
        'api.annotation': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 29, 16, 59, 49, 408376)', 'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'deleted_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'has_answers': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 29, 16, 59, 49, 408405)', 'auto_now': 'True', 'blank': 'True'}),
