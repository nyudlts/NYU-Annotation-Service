...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('api_constraint', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.IntegerField')()),
            ('blob', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('api', ['Constraint'])

        # Adding M2M table for field target on 'Constraint'
        db.create_table('api_constraint_target', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('constraint', models.ForeignKey(orm['api.constraint'], null=False)),
            ('target', models.ForeignKey(orm['api.target'], null=False))
        ))
        db.create_unique('api_constraint_target', ['constraint_id', 'target_id'])


    def backwards(self, orm):
        
        # Deleting model 'Constraint'
        db.delete_table('api_constraint')

        # Removing M2M table for field target on 'Constraint'
        db.delete_table('api_constraint_target')
