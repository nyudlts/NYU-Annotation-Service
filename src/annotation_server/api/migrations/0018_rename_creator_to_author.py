...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('api_annotation', 'creator_id', 'author_id')


    def backwards(self, orm):
        db.rename_column('api_annotation', 'author_id', 'creator_id')
    ...
    models = {
        'api.annotation': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 3, 9, 13, 46, 759806)', 'auto_now_add': 'True', 'blank': 'True'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'deleted_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'has_answers': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 3, 9, 13, 46, 759838)', 'auto_now': 'True', 'blank': 'True'}),
